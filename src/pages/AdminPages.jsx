...
import { FaUserMd, FaEdit, FaTrash, FaCheck, FaSearch, FaUsers, FaUserTie, FaClock, FaUser, FaTimes } from "react-icons/fa";
import { collection, onSnapshot, query, where, doc, updateDoc } from "firebase/firestore";
import { db } from "../firebase";
import { updateUserProfile, deleteUser } from "../firebase";
import { LoadingSkeletonRow, EmptyState, AlertModal } from "../components/CommonComponents";
            ...
            <div key={request.id} style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: '#666', fontWeight: 500 }}>ต้องการเป็น:</span>
                  <span style={{
                ...
                <div style={{
                  ...
                  <span style={{ color: '#666', fontWeight: 500 }}>สมัครเมื่อ:</span>
                ...
                <div style={{
                  ...
                  <span style={{ color: '#666', fontWeight: 500 }}>สถานะปัจจุบัน:</span>
                  <span style={{ color: '#1a1a1a' }}>
...
const DoctorManagementPage = ({ lang, setProfileToView, db, isDirty, handleSaveProfile }) => {
...
const PatientManagementPage = ({ lang, setProfileToView, db, isDirty, handleSaveProfile }) => {
  const navigate = useNavigate();
          ...
          {isLoading ? (
            ...
            filteredPatients.map((patient) => (
              <tr
                ...
                onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
              >
                <td style={{ padding: '1rem' }}>{patient.displayName || "N/A"}</td>
